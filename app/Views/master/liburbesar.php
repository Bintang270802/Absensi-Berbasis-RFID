                                            ...
                                            <div class="table-responsive">
                                                <table id="example" class="table table-striped table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php 
                                                        $no=0;
                                                        foreach ($getLiburbesar as $data) {  
                                                            $id = $data['id_liburbesar'];
                                                        $no++;
                                                        ?>
                                                        <tr>
                                                            <td><?= $no ?></td>
                                                            <td><?= $data['keterangan'] ?></td>
                                                            <td><?= formatTanggal($data['tgl_libur']) ?></td>
                                                            <td>
                                                                ...
                                                                <div class="modal fade" id="edit<?=$id;?>">
                                                                    ...
                                                                    <!-- Modal body -->
                                                                    <form method="post" action="<?= base_url('Liburbesar/update'); ?>">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-12">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="date" class="form-control" name="tgl" value="<?=$data['tgl_libur']?>" required>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div class="modal fade" id="delete<?=$id?>">
                                                                    ...
                                                                    <!-- Modal body -->
                                                                    <form method="post" action="<?= base_url('Liburbesar/hapus'); ?>">
                                                                        <div class="modal-body">
...
<!-- Modal Header -->
<div class="modal-header">
<h4 class="modal-title">Tambah Data Libur</h4>
<button type="button" class="close" data-dismiss="modal">&times;</button>
</div>
                
<!-- Modal body -->
<form class="was-validated" method="post" action="<?= base_url('Liburbesar/add'); ?>">
    <div class="modal-body">
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
