                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php 
                                                        $no=0;
                                                        foreach ($getTingkat as $data) {  
                                                            $id = $data['id_tingkat_kelas'];
                                                        $no++;
                                                        ?>
                                                        <tr>
                                                            <td><?= $no ?></td>
                                                            <td><?= $data['id_tingkat_kelas'] ?></td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="modal fade" id="edit<?=$id;?>">
                                                                    ...
                                                                    <!-- Modal body -->
                                                                    <form method="post" action="<?= base_url('Tingkatkelas/update'); ?>">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" class="form-control" name="nama" value="<?=$data['nm_tingkat_kelas']?>" required>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div class="modal fade" id="delete<?=$id?>">
                                                                    ...
                                                                    <!-- Modal body -->
                                                                    <form method="post" action="<?= base_url('Tingkatkelas/hapus'); ?>">
                                                                        <div class="modal-body">
                                                                            Apakah anda yakin ingin menghapus Data <?=$data['nm_tingkat_kelas'];?>?
...
<!-- Modal body -->
<form class="was-validated" method="post" action="<?= base_url('Tingkatkelas/add'); ?>">
    <div class="modal-body">
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
